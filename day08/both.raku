...
# 5. Likewise, whichever sig-semgent digit is missing one of our candidates for
...
#    a 5-segment digit with either of them plus a,c,d, and f. That will be the
#    3, and the segment present will be g, meaning the other one is e.                          SOLVED: a, b, c, d, e, f, g
